...
<form class="o-form" action="/collections/{{$id}}" method="POST">
    ...
    @include('formandsystem-content::forms.input',['name' =>'name', 'label' => 'Collection Name', 'value' => $name, 'attr' => 'required'])

    @include('formandsystem-content::forms.input',['name' =>'slug', 'label' => 'Path/Slug', 'value' => $slug, 'attr' => 'required'])
